...
class Tracker:
    ...
    def update(self, detections, classes):
        ...
        # print("matches, unmatched_tracks, unmatched_detections", len(matches), len(unmatched_tracks), len(unmatched_detections))
        # Update track set.
    ...
    def _initiate_track(self, detection, class_id):
        ...
        # print("self.tracks", [[i.to_tlwh(), i.track_id, i.class_id] for i in self.tracks])
        # print("Current detection", detection.to_xyah())
        # print("self._next_id, class_id, self.n_init, self.max_age", self._next_id, class_id, self.n_init, self.max_age)
